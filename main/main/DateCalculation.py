...
class Ui_DateCalculation(object):
    def setupUi(self, DateCalculation):
        ...
        self.calendarWidget.setGeometry(QtCore.QRect(0, 80, 541, 240))
        self.calendarWidget.setObjectName("calendarWidget")
        self.calendarWidget_2 = QtWidgets.QCalendarWidget(DateCalculation)
        self.calendarWidget_2.setGeometry(QtCore.QRect(0, 360, 541, 240))
    ...
    def retranslateUi(self, DateCalculation):
        ...
        self.mode_name.setText(_translate("DateCalculation", "Date Calculation"))
